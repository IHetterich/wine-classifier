...
class Recommender(object):
    '''
    A class to house the text vecotirzer and stacked Naive Bayes/Random Forest 
    ...
    def predict(self, text):
        ...
        Parameters
        ----------
        text - The input tastings notes.

        Returns
        ----------
        top_five - The top five predicted varieties for recommendation.
        '''
